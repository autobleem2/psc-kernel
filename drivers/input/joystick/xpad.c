...
/*
 * Backported from Linux 6.1 to the PlayStation Classic's 4.4 kernel (AutoBleem):
 * the few things 4.4 lacks are shimmed here.
 */
#ifndef ABS_PROFILE
/* 6.1's axis for the Elite 2 / Adaptive Controller profile switch (uapi, value from 5.13) */
#define ABS_PROFILE		0x21
#endif

#if LINUX_VERSION_CODE < KERNEL_VERSION(5, 11, 0)
/* 4.4 has no inhibited input devices: "enabled" is "opened by someone" */
static inline bool input_device_enabled(struct input_dev *dev)
{
...
static const struct xpad_device {
	...
	{ 0x1532, 0x0037, "Razer Sabertooth", 0, XTYPE_XBOX360 },	/* 4.4 had it, 6.1 dropped it */
