...
/*
 * Backported from Linux 6.1 to the PlayStation Classic's 4.4 kernel (AutoBleem). The ids 4.4's
 * hid-ids.h lacks are defined here; hid-core.c's hid_have_special_driver list needs the same ids.
 */
#ifndef HID_GD_RFKILL_BTN
#define HID_GD_RFKILL_BTN	0x000100c6
#endif
#ifndef USB_DEVICE_ID_MS_DIGITAL_MEDIA_7K
#define USB_DEVICE_ID_MS_DIGITAL_MEDIA_7K	0x00b4
#endif
#ifndef USB_DEVICE_ID_MS_DIGITAL_MEDIA_3KV1
#define USB_DEVICE_ID_MS_DIGITAL_MEDIA_3KV1	0x0732
#endif
#ifndef USB_DEVICE_ID_MS_DIGITAL_MEDIA_600
#define USB_DEVICE_ID_MS_DIGITAL_MEDIA_600	0x0750
#endif
#ifndef USB_DEVICE_ID_MS_COMFORT_KEYBOARD
#define USB_DEVICE_ID_MS_COMFORT_KEYBOARD	0x00e3
#endif
#ifndef USB_DEVICE_ID_MS_SURFACE_DIAL
#define USB_DEVICE_ID_MS_SURFACE_DIAL		0x091b
#endif
#ifndef USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1708
#define USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1708	0x02fd
#endif
#ifndef USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1708_BLE
#define USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1708_BLE	0x0b20
#endif
#ifndef USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1914
#define USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1914	0x0b13
#endif
#ifndef USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1797
#define USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1797	0x0b05
#endif
#ifndef USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1797_BLE
#define USB_DEVICE_ID_MS_XBOX_CONTROLLER_MODEL_1797_BLE	0x0b22
#endif
/* the SN30 Pro+ in its Xbox mode, under Microsoft's vendor id */
#ifndef USB_DEVICE_ID_8BITDO_SN30_PRO_PLUS
...
static int ms_probe(struct hid_device *hdev, const struct hid_device_id *id)
{
	...
	/*
	 * 4.4's hid-input has no input device per application collection; the Surface Dial
	 * keeps its axis filtering but shares one input device.
	 */
#ifdef HID_QUIRK_INPUT_PER_APP
	if (quirks & MS_SURFACE_DIAL)
...
static const struct hid_device_id ms_devices[] = {
	...
	/*
	 * 4.4 only: the Surface type covers are still claimed here (6.1 leaves them to
	 * hid-multitouch/hid-generic); 4.4's hid-core forces them to the generic group.
	 */
	...
	{ HID_BLUETOOTH_DEVICE(USB_VENDOR_ID_MICROSOFT, USB_DEVICE_ID_MS_PRESENTER_8K_BT),
		.driver_data = MS_PRESENTER },
	{ HID_BLUETOOTH_DEVICE(USB_VENDOR_ID_MICROSOFT, USB_DEVICE_ID_MS_SURFACE_DIAL),
